...
function gotResult(error, results) {
    if(error){
        ...
        document.getElementById("detect").style.color = "rgb("+random_number_r+","+random_number_g+","+random_number_b+")";
        document.getElementById("detect").style.fontFamily = 'Courier New'+","+'Courier'+","+'monospace';

        document.getElementById("voice").innerHTML = "Detect Voice Is Of - "+results[0].label;
        ...
        if(results[0].label == "Barking"){
            ...
            dog = dog+1;
            document.getElementById("detect").innerHTML = "Detected Dog - "+ dog;
        }
        else if(results[0].label == "Meowing"){
            img.src = "https://shravaripatil.github.io/Sound_controlled_animals/meow.gif";
            cat = cat+1;
            document.getElementById("detect").innerHTML = "Detected Cat - "+ cat;
        }
            ...
            lion = lion+1;
            document.getElementById("detect").innerHTML = "Detected Lion - "+ lion;
        }
            ...
            cow = cow+1;
            document.getElementById("detect").innerHTML = "Detected Cow - "+ cow;
        }
        else{
            img.src = "https://shravaripatil.github.io/Sound_controlled_animals/listen.gif";
            background_noise = background_noise+1;
            document.getElementById("detect").innerHTML = "Detected Background Noise - "+ background_noise;
        }
    }
}